...
namespace Dyplomka
{
    public partial class FormOrdersOfTheEmployees : Form
    {
        public FormOrdersOfTheEmployees()
        {
            InitializeComponent();
        ...
        private void FormOrdersOfTheEmployees_Load(object sender, EventArgs e)
        {
        ...
        private void buttonReport_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            FormTheReportOfOrdersOfTheEmployees formTheReportOfOrdersOfTheEmployees = new FormTheReportOfOrdersOfTheEmployees();
            formTheReportOfOrdersOfTheEmployees.Show();
        }
